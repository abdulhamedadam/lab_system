...
@section('content')
    ...
    <div id="kt_app_content_container" class="t_container">
        ...
        <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
            ...
            <form action="{{ route('admin.loans.store') }}" method="post" enctype="multipart/form-data" id="store_form">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="mb-10 fv-row col">
                            ...
                            <select name="emp_id" id="emp_id"
                                ...
                                @foreach($employees as $emp)
                                    <option value="{{ $emp->id }}">{{ $emp->first_name.' '.$emp->last_name .'( code-'.$emp->emp_code.')' }}</option>
                                @endforeach
                    ...
                    <div class="row">                     <!--end::Input group-->
                        <div class="mb-10 fv-row col">
                            ...
                            <input type="date"
                                ...
                                name="date_loan"
                                placeholder="Pick date rage" id="date_loan" value="{{old('date_loan',date('Y-m-d'))}}"/>
                        ...
                        <div class="mb-10 fv-row col">
                            ...
                            <input type="date" name="date_deductions" class="form-control form-control-solid @error('date_deductions') is-invalid  @enderror" value="{{old('date_deductions')}}"/>
