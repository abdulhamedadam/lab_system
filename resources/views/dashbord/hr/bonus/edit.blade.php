...
@section('content')
    ...
    <div id="kt_app_content_container" class="t_container">
        ...
        <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
            ...
            <form action="{{ route('admin.bonuses.update',$bonus->id) }}" method="post" enctype="multipart/form-data"
                  id="store_form">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-10 fv-row col">
                            ...
                            <select name="emp_id" id="emp_id"
                                ...
                                @foreach($employees as $emp)
                                    <option
                                        value="{{ $emp->id }}" @if($emp->id==$bonus->emp_id) selected @endif>{{ $emp->first_name.' '.$emp->last_name .'( code-'.$emp->emp_code.')' }}</option>
                                @endforeach
                        ...
                        <div class="mb-10 fv-row col">
                            ...
                            <input type="text" name="value" id="value" value="{{old('value',$bonus->value)}}"
                        ...
                        <div class="mb-10 fv-row col">
                            ...
                            <label class="required fs-6 fw-semibold mb-2">{{trans('loan.date_bonuses')}}</label>
                            <input type="date" name="date_bonuses"
                                   class="form-control form-control-solid @error('date_bonuses') is-invalid  @enderror"
                                   value="{{old('date_bonuses',$bonus->date_bonuses)}}"/>
                            @error('date_bonuses')
                            <div
                        ...
                        <div class="row">
                            <div class="mb-10 fv-row col">
                                ...
                                <textarea class="form-control @error('reason') is-invalid @enderror"
                                          ...
                                          id="reason" name="reason">{{old('reason',$bonus->reason)}}</textarea>
                                @error('reason')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
