...
@section('toolbar')
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            {{ AddButton(route('admin.payroll.create')) }}
        ...
        <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
            @php
                $headers = [
                    ...
                    'tests.to_date',
                    'tests.report_date',
                    'tests.total_main_salary',
                    'tests.total_bonus',
                    'tests.total_deductions',
                    'tests.total_loans',
                    'tests.grand_total',
                    'tests.actions',
                ];
        ...
        $(document).ready(function() {
            ...
            table = $('#table1').DataTable({
                ...
                "columns": [
                    ...
                    {data: 'total_main_salary', name: 'total_main_salary'},
                    {data: 'total_bonus', name: 'total_bonus'},
                    {data: 'total_deductions', name: 'total_deductions'},
                    {data: 'total_loans', name: 'total_deductions'},
                    {data: 'grand_total', name: 'total_deductions'},
