                    ...
                    <div class="row">
                        ...
                        <div class="mb-10 fv-row col">
                            ...
                            <select name="emp_id" id="emp_id"
                                ...
                                @foreach($employees as $emp)
                                    <option
                                        value="{{ $emp->id }}" @if($emp->id == $deduction->emp_id) @endif>{{ $emp->first_name.' '.$emp->last_name .'( code-'.$emp->emp_code.')' }}</option>
                                @endforeach
                        ...
                        <div class="mb-10 fv-row col">
                            ...
                            <input type="text" name="value" id="value"
                                   ...
                                   class="form-control mb-2  @error('value') is-invalid @enderror" value="{{old('value',$deduction->value)}}"
                                   placeholder="value"/>
                            <!--end::Input-->
                            @error('value')
                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-10 fv-row col">
                            ...
                            <input type="date" name="date_deductions"
                                   ...
                                   value="{{old('date_deductions',$deduction->date_deductions)}}"/>
                        ...
                        <div class="row">
                            <div class="mb-10 fv-row col">
                                ...
                                <textarea class="form-control @error('reason') is-invalid @enderror"
                                          ...
                                          id="reason" name="reason">{{old('reason',$deduction->reason)}}</textarea>
                                @error('reason')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
