...
<div class="profile-card" style="margin-top: -20px">
    <div class="profile-header">
        <img
            src="{{ $all_data->image && file_exists(public_path('images/'.$all_data->image)) ? asset('images/'.$all_data->image) : asset('images/default-user-icon.png') }}"
            alt="{{ $all_data->name }}"
            class="profile-img">
    ...
    <div class="profile-stats">
        <div class="stat-item">
            ...
            <div class="stat-label"><?= trans('clients.projects') ?></div>
        </div>
        <div class="stat-item">
            <div class="stat-number">{{$companies_data->count()}}</div>
            <div class="stat-label"><?= trans('clients.companyies') ?></div>
        </div>
        <div class="stat-item">
            <div class="stat-number">40</div>
            <div class="stat-label"><?= trans('clients.tests') ?></div>
        </div>
    </div>
