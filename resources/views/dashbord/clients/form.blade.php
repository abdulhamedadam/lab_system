                    ...
                    <div class="col-md-12 row" style="margin-top: 10px">
                        <div class="col-md-3">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="text" class="form-control" name="client_code" id="client_code" value="{{$client_code}}" readonly>
                            </div>
                            @error('client_code')
                    ...
                    <div class="col-md-12 row" style="margin-top: 10px">
                                ...
                                <div class="overflow-hidden flex-grow-1">
                                    <select class="form-select rounded-start-0" name="governate" id="governate" onchange="get_area(this.value)" data-placeholder="{{trans('clients.select')}}">
                                        ...
                                        @foreach($governates as $item)
                                            <option value="{{$item->id}}" {{ old('governate') == $item->id ? 'selected' : '' }}>{{$item->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group flex-nowrap ">
                                <span class="input-group-text" id="basic-addon3"><i class="bi bi-caret-down fs-2"></i></span>
                                <div class="overflow-hidden flex-grow-1">
                                    <select class="form-select rounded-start-0" name="city" id="city" value="{{old('city')}}" data-placeholder="{{trans('clients.select')}}">
                                        <option value="">{{trans('clients.select')}}</option>
                                    </select>
                                </div>
                            </div>
