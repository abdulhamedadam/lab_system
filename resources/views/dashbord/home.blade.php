                    ...
                    <div class="row g-5 g-xl-10 mb-xl-10">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                            ...
                            <div
                                ...
                                <div class="card-header pt-5">
                                    <div class="card-title d-flex flex-column">
                                        <span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{$soil_test_count}}</span>
                                        <span class="text-white opacity-50 pt-1 fw-semibold fs-6">{{trans('dashborad.tests')}}</span>

                                    </div>

                                </div>
                                <?php
                                $percentage = ($soil_test_count > 0) ? ($soil_done_count / $soil_test_count) * 100 : 0;
                                ?>
                                <div class="card-body d-flex align-items-end pt-0">
                                    ...
                                    <div class="d-flex align-items-center flex-column mt-3 w-100">
                                        <div
                                            ...
                                            <span>{{$soil_done_count}}-done</span>
                            ...
                            <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                                <div class="card-header pt-5">
                                    <div class="card-title d-flex flex-column">
                                        <span class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2">{{$companies_count}}</span>
                                        <span class="text-gray-500 pt-1 fw-semibold fs-6">{{trans('dashboard.companies')}}</span>
                                    </div>

                                </div>
                                <div class="card-body d-flex flex-column justify-content-end pe-0">
                                    <span class="fs-6 fw-bolder text-gray-800 d-block mb-2">{{trans('dashboard.todays_company')}}</span>

                                    @foreach($todayes_companies as $company)
                                    <div class="symbol-group symbol-hover flex-nowrap">
                                        <a href="{{route('admin.company_projects',$company->id)}}" class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Alan Warden">
                                            <span class="symbol-label bg-warning text-inverse-warning fw-bold">{{$company->name}}</span>
                                        </a>
                                ...
                                <div class="card-header pt-5">
                                    <div class="card-title d-flex flex-column">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2">{{$dues}}</span>
                                            @php
                                                $percentage = $last_month_dues != 0 ? ($dues / $last_month_dues) * 100 : 0;
                                                $isIncrease = $dues >= $last_month_dues;
                                            @endphp

                                            <span class="badge badge-light-{{ $isIncrease ? 'success' : 'danger' }} fs-base">
                                               <i class="ki-duotone ki-arrow-{{ $isIncrease ? 'up' : 'down' }} fs-5 text-{{ $isIncrease ? 'success' : 'danger' }} ms-n1">
                                                     <span class="path1"></span>
                                                     <span class="path2"></span>
                                               </i> {{ number_format($percentage, 2) }}%
                                            </span>


                                        </div>
                                        <span class="text-gray-500 pt-1 fw-semibold fs-6">Tests Earnings in <?= date('F'); ?></span>
                                ...
                                <div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
                                    ...
                                    <div class="d-flex flex-column content-justify-center flex-row-fluid">
                                        ...
                                        <div class="d-flex fw-semibold align-items-center">
                                            ...
                                            <div class="text-gray-500 flex-grow-1 me-4">Soil Test</div>

                                            <div class="fw-bolder text-gray-700 text-xxl-end">${{$soil_dues}}</div>
                                        ...
                                        <div class="d-flex fw-semibold align-items-center my-3">
                                            ...
                                            <div class="text-gray-500 flex-grow-1 me-4">Concerte Test</div>

                                            <div class="fw-bolder text-gray-700 text-xxl-end">${{$concrete_dues}}</div>
                                        ...
                                        <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_1">
                                            ...
                                            <div class="d-flex align-items-center mb-6">
                                                ...
                                                <div class="flex-grow-1 me-5">
                                                    ...
                                                    <!--end::Time-->
                                                    <!--begin::Description-->
                                                    <div class="text-gray-700 fw-semibold fs-6">9 Degree Project
                                                        Estimation Meeting
                                                    </div>
                                                    <!--end::Description-->
                                                    <!--begin::Link-->
                                    ...
                                    <div class="row gx-9 h-100">
                                        ...
                                        <div class="col-sm-6 mb-10 mb-sm-0">
                                            ...
                                            <div
                                                ...
                                                style="background-size: 100% 100%;background-image:url('assets/media/stock/600x600/img-33.jpg')"></div>
                                            <!--end::Image-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
    ...
    <script>
        var KTProjectList = function () {
            var initChart = function () {
                ...
                var element = document.getElementById("kt_card_widget_17_chart1");
                ...
                var config = {
                    ...
                    data: {
                        datasets: [{
                            data: [30, 45, 25],
                            backgroundColor: ['#00A3FF', '#3a1f4e', '#E4E6EF']
                        }],
