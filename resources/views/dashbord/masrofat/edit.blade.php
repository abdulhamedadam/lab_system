                ...
                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="date" class="form-control" name="sarf_date" id="sarf_date"
                                        value="{{ old('sarf_date', $all_data->sarf_date ? \Carbon\Carbon::parse($all_data->sarf_date)->format('Y-m-d') : now()->format('Y-m-d')) }}">
                            </div>
                            @error('sarf_date')
                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-md-12" style="margin-top: 10px">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="sarf_details" name="sarf_details" rows="3">{{ old('sarf_details', $all_data->sarf_details) }}</textarea>
                            @error('sarf_details')
                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                            @enderror
                        </div>
