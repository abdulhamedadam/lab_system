...
@section('content')
    ...
    <div id="kt_app_content_container" class="t_container">
        ...
        <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
            @php
                generateCardHeader('tests.edit_external_test','admin.project.index',' ')
            @endphp


            <form action="{{ route('admin.external_test.update',$test['id']) }}" method="post" enctype="multipart/form-data"
                  id="store_form">
                @csrf
                <div class="card-body">
                    <div class="col-md-12 row" style="margin-top: 10px">
                        <div class="col-md-3">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="text" class="form-control" name="test_code_st" id="test_code_st" value="{{old('test_code_st',$test['test_code_st'])}}">
                            </div>
                            @error('test_code_st')
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <select class="form-select" data-control="select2" name="client_id" id="client_id">
                                    ...
                                    @foreach($clients as $item)
                                        <option
                                            value="{{$item->id}}" {{ old('client_id',$test['client_id']) == $item->id ? 'selected' : '' }}>{{$item->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <select class="form-select" data-control="select2" name="company_id" id="company_id">
                                    ...
                                    @foreach($companies as $item)
                                        <option
                                            value="{{$item->id}}" {{ old('client_id',$test['company_id']) == $item->id ? 'selected' : '' }}>{{$item->name}}</option>
                                    @endforeach
                                </select>
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            ...
                            <div class="input-group flex-nowrap">
                                <select class="form-select" data-control="select2" name="project_id" id="project_id">
                                    ...
                                    @foreach($projects as $item)
                                        <option
                                            value="{{$item->id}}" {{ old('client_id',$test['client_id']) == $item->id ? 'selected' : '' }}>{{$item->project_name}}</option>
                                    @endforeach
                                </select>
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="number" class="form-control" name="wared_number" id="wared_number"
                                       value="{{ old('wared_number',$test['wared_number']) }}">
                            </div>
                            @error('wared_number')
                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="date" class="form-control" name="wared_date" id="wared_date"
                                       value="{{ old('wared_date',$test['wared_date']) }}">
                            </div>
                            @error('wared_date')
                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="text" class="form-control" name="talab_number" id="talab_number"
                                       value="{{ old('talab_number',$test['talab_number']) }}">
                            </div>
                            @error('talab_number')
                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="text" class="form-control" name="talab_title" id="talab_title"
                                       value="{{ old('talab_title',$test['talab_title']) }}">
                            </div>
                            @error('talab_title')
                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="date" class="form-control" name="talab_date" id="talab_date"
                                       value="{{ old('talab_date',$test['talab_date']) }}">
                            </div>
                            @error('talab_date')
                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="date" class="form-control" name="talab_end_date" id="talab_end_date"
                                       value="{{ old('talab_end_date',$test['talab_end_date']) }}">
                            </div>
                    ...
                    <div class="col-md-12 row" style="margin-top: 20px">
                        <div class="col-md-2">
                            ...
                            <div class="input-group flex-nowrap">
                                <span class="input-group-text" id="basic-addon3">{!! form_icon('text') !!}</span>
                                <input type="number" class="form-control" name="sample_num" id="sample_num" value="{{old('sample_num',$test['talab_end_date'])}}">
                            </div>
                            @error('sample_num')
                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group flex-nowrap">
                                <span class="input-group-text" id="basic-addon3">{!! form_icon('text') !!}</span>
                                <input type="number" class="form-control" name="sample_cost" id="sample_cost" value="{{old('sample_cost',$test['sample_cost'])}}">
                            </div>
                            @error('sample_cost')
                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                            @enderror
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <select class="form-select" name="discount_type" id="discount_type">
                                    ...
                                    @foreach($discount_type as $index=>$value)
                                        <option
                                            value="{{$index}}" {{ old('discount_type',$test['discount_type']) == $index ? 'selected' : '' }}>{{$value}}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('discount_type')
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="number" class="form-control" name="discount" id="discount" value="{{old('discount',$test['discount'])}}">
                            </div>
                            @error('discount')
                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group flex-nowrap">
                                <span class="input-group-text" id="basic-addon3">{!! form_icon('text') !!}</span>
                                <input type="number" class="form-control" name="total_cost" id="total_cost" value="{{old('total_cost',$test['total_cost'])}}">
                            </div>
                            @error('total_cost')
                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-md-12 row" style="margin-top: 20px">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <select class="form-select rounded-start-0" name="test_category" id="test_category">
                                    ...
                                    @foreach($test_type as $key=>$value)
                                        <option
                                            value="{{$key}}" {{ old('test_category',$test['test_category']) == $key ? 'selected' : '' }}>{{$value}}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('test_category')
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="input-group flex-nowrap">
                                <span class="input-group-text" id="basic-addon3">{!! form_icon('text') !!}</span>
                                <input type="text" class="form-control" name="test" id="test" value="{{$test['test']}}">
                            </div>
                            @error('test')
                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="date" class="form-control" name="sader_date" id="sader_date" value="{{old('sader_date',$test->sader->sader_date)}}">
                            </div>
                            @error('sader_date')
                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="number" class="form-control" name="sader_num" id="sader_num" value="{{old('sader_date',$test->sader->sader_num)}}">
                            </div>
                            @error('sader_num')
                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                            @enderror
