    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    {{trans('Toolbar.clients_account_statement')}}
                </li>
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-400 w-5px h-2px"></span>
                </li>
        ...
        <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
            ...
            <div class="card-body pt-0">
                <div class="row" style="margin-top:20px">
                    ...
                    <div class="col-md-3">
                        <button type="button" class="btn btn-success" onclick="get_company_statment()" id="searchButton" style="margin-top: 30px;">
...
@section('js')
    ...
    <script>
        function get_company_statment() {
            var clientId = $('#client_id').val();
            var fromDate = $('#from_date').val();
            var toDate = $('#to_date').val();
            $.ajax({
                url: '{{route('admin.payment.get_company_statment')}}',
                type: 'get',
                data: {
                    client_id: clientId,
                    from_date: fromDate,
