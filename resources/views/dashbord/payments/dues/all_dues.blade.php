                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered" id="table1">
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="5" class="text-center" style="background-color: lightslategrey">
                                            الإجمالي</th>
                                        <th class="text-center" id="total-cost" style="background-color: lightcoral">
                                        </th>
                                        <th class="text-center" id="total-paid" style="background-color: lightgreen">
                                        </th>
                                        <th class="text-center" id="total-remain"
                                            style="background-color: lightgoldenrodyellow"></th>
                                        <th colspan="4"></th>
                                    </tr>
                                </tfoot>
                            </table>
                ...
                $(document).ready(function() {
                    table = $('#table1').DataTable({
                        ...
                        "footerCallback": function(row, data, start, end, display) {
                            ...
                            var totalCost = api.column(5, {
                                page: 'current'
                            }).data().reduce((a, b) => intVal(a) + intVal(b), 0);
                            var totalPaid = api.column(6, {
                                page: 'current'
                            }).data().reduce((a, b) => intVal(a) + intVal(b), 0);
                            var totalRemain = api.column(7, {
                                page: 'current'
                            }).data().reduce((a, b) => intVal(a) + intVal(b), 0);
