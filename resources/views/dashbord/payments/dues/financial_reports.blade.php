        ...
        <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
            ...
            <div class="card-body pt-0">
                <div class="row" style="margin-top:20px">
                    ...
                    <div class="col-md-3">
                        <button type="button" class="btn btn-success" onclick="get_financial_reports()" id="searchButton" style="margin-top: 30px;">
...
@section('js')
    ...
    <script>
        function get_financial_reports() {
            ...
            $.ajax({
                url: '{{route('admin.payment.get_financial_reports')}}',
                type: 'get',
                data: {
                    from_date: fromDate,
                    to_date: toDate
