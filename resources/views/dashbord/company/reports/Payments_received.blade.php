...
<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
    ...
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
            ...
            <li class="breadcrumb-item text-muted">
                {{trans('Toolbar.company_reports')}}
            </li>
            <li class="breadcrumb-item">
                <span class="bullet bg-gray-400 w-5px h-2px"></span>
            </li>
            <li class="breadcrumb-item text-muted">
                {{trans('Toolbar.Payments_received')}}
            </li>
            <li class="breadcrumb-item">
                <span class="bullet bg-gray-400 w-5px h-2px"></span>
            </li>
...
<div id="kt_app_content_container" class="app-container container-xxxl">
    ...
    <div class="card mb-6 mb-xl-9">
        <div class="card-body pt-9 pb-0">
            ...
            @include('dashbord.company.reports.nav')
    ...
    <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
        ...
        <div class="card-body pt-0">
            <div class="row" style="margin-top:20px">
                <div class="col-md-3">
                    <label for="first_name" class="form-label">{{ trans('company.company') }}</label>
...
<script>
    function get_revenue_report() {
        ...
        $.ajax({
            url: '{{route('admin.get_Payments_received')}}',
            type: 'get',
            data: {
                from_date: fromDate,
