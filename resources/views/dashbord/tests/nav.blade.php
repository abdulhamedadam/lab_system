        ...
        <div class="card-body" style="padding: 10px">
         ...
         btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2
          {{ request()->routeIs('admin.samples_test') ? 'active' : '' }}">
                        ...
                        <span class="nav-text text-gray-800 fw-bold fs-6 lh-1">{{trans('tests.tests')}}</span>
                ...
                btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2">
                        ...
                        <span class="nav-text text-gray-800 fw-bold fs-6 lh-1">{{trans('tests.reports')}}</span>
                        <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                    </a>
                </li>
              ...
              btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2">
                        ...
                        <span class="nav-text text-gray-800 fw-bold fs-6 lh-1">{{trans('tests.money_track')}}</span>
                        <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                    </a>
                </li>
