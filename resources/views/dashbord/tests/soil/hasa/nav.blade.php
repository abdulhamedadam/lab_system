...
<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
    ...
    <li class="nav-item">
        <a class="nav-link text-active-primary py-5 me-6 {{ request()->routeIs('admin.hasa_samples_test', $all_data->id) ? 'active' : '' }}"
           href="{{route('admin.hasa_samples_test',$all_data->id)}}">
