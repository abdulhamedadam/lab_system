...
<div class="container-fluid">
    <div class="row report-header">
        <div class="d-flex align-items-center">
            ...
            <div class="ml-3">
                <h3 style="margin-bottom: 0; line-height: normal;"><span style="color: orange;">ALSHARQ</span> TESTS
                    LABORATORY</h3>
                <p style="margin-bottom: 0; line-height: normal;">Registration No. under Iraqi accreditation system is
                    (124)</p>
                <p style="margin-bottom: 0; line-height: normal;">Registration No. under Iraqi Engineer Union is
                    (508)</p>
            </div>
        </div>
    ...
    <div class="" dir="rtl">
        ...
        <div class="row d-flex flex-wrap" style="margin-top: 10px">
            <div class="col-md-3 text-start">
                <strong>رقم الصـــــــــــادر
                    :</strong>&nbsp;&nbsp;&nbsp;&nbsp;{{$compaction_test[0]->sader_num ?? 'N/A'}}
            </div>
            <div class="col-md-3 text-end">
                <strong>تاريخ الصـادر :</strong>&nbsp;&nbsp;&nbsp;&nbsp;{{$compaction_test[0]->sader_date ?? 'N/A'}}
            </div>
        </div>
        ...
        <div class="row d-flex flex-wrap">
            ...
            <div class="col-md-3 text-end">
                <strong>رقم الفاتــورة
                    :</strong>&nbsp;&nbsp;&nbsp;&nbsp;{{get_app_config_data('soil_prefix').$all_data->test_code}}
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 text-start">
                <p>اشارة لكتابكم المرقم ({{$all_data->talab_number}}) المؤرخ {{$all_data->talab_date}}, ندرج لكم ادناه
                    نتائج الفحص لنقاط الحدل التي تم اخذها من الموقع للمشروع اعلاه راجين الاطلاع واتخاذ اللازم ..</p>
            </div>
        </div>
        ...
        @if(!empty($compaction_test) && $compaction_test[0]->compaction_test_details->isNotEmpty())
            @foreach ($compaction_test[0]->compaction_test_details as $test)
                <tr>
                    ...
                    <td>{{ $test->compaction > $test->req_compaction  ? $test->compaction : $test->compaction .'**'}}</td>
    ...
    <div class="row" dir="rtl">
        <div class="col-12 text-start">
            <strong>الملاحـــظات :</strong>&nbsp;&nbsp;&nbsp;&nbsp;
            <span style="text-decoration: underline;color:red"></span>
        </div>

        <div class="col-12 text-start">
            <strong>1-النمذجة :</strong>&nbsp;&nbsp;&nbsp;&nbsp;
            <span>تمت النمذجة من قبل كادر المختبر المتمثل بالمنمذج ({{$all_data->monamzig_id ?? ''}}) وبحضور مخول {{$all_data->authorized_name??''}} </span>
        </div>

        <div class="col-12 text-start">
            <strong>2-تقويم النموذج :</strong>&nbsp;&nbsp;&nbsp;&nbsp;
            <span>النتيجة المؤشرة بالعلامة (**) غير محققة للقيمة المطلوبة</span>
        </div>

        <div class="col-12 text-start">
            <strong>3-ملاحظات يطلبها العميل :</strong>&nbsp;&nbsp;&nbsp;&nbsp;
            <span></span>
        </div>

        <div class="col-12 text-start">
            <strong>4-تم اعتماد قيمة الكثافة المختبرية (بروكتور- المعدل) :</strong>&nbsp;&nbsp;&nbsp;&nbsp;
            <span></span>
        </div>
