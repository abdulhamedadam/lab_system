...
@section('toolbar')
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack" style="margin-top: 30px">
        <!--begin::Page title-->
            ...
            <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
                ...
                <div class="card-body" style="padding-left: 0px !important;">
                    <div class="col-md-12 row">
                        <div class="col-md-8">
                            @include('dashbord.tests.soil.payments.form')
                        </div>
                        <div class="col-md-4">
                            @include('dashbord.tests.soil.payments.details')

                        </div>
                        @include('dashbord.tests.soil.payments.data')
                    </div>
