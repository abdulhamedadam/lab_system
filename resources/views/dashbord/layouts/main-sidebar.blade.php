               ...
               <div data-kt-menu-trigger="click" class="menu-item menu-accordion
                ...
                <div class="menu-item pt-5">
                    ...
                    <div class="menu-content">
                           <span
                               class="menu-heading fw-bold text-uppercase fs-7">{{trans('sidebar.finance_management')}}</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link   @if (in_array(optional(explode('.', Route::currentRouteName()))[2], array('accounts'))) {{'active'}} @endif"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link   @if (in_array(optional(explode('.', Route::currentRouteName()))[2], array('Receipt_Voucher'))) {{'active'}} @endif"
