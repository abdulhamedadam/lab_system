                ...
                <form action="{{ route('admin.save_employee') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12 row" style="margin-top: 10px">
                            ...
                            <div class="col-md-3">
                                <label for="basic-url"class="form-label">{{trans('employees.governate')}}</label>
                                <div class="input-group flex-nowrap ">
                                    <span class="input-group-text" id="basic-addon3"><i class="bi bi-caret-down fs-2"></i></span>
                                    <div class="overflow-hidden flex-grow-1">
                            ...
                            <div class="col-md-3">
                                <label for="basic-url" class="form-label">{{trans('employees.area')}}</label>
                                <div class="input-group flex-nowrap ">
                                    <span class="input-group-text" id="basic-addon3"><i class="bi bi-caret-down fs-2"></i></span>
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="form-select rounded-start-0" name="area_id" id="area_id" value="{{old('area_id')}}" data-placeholder="{{trans('employees.select')}}">
                                            <option value="">{{trans('employees.select')}}</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12 row" style="margin-top: 10px">
                            <div class="col-md-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    <span class="input-group-text" id="basic-addon3"><i class="bi bi-building fs-2"></i></span>
