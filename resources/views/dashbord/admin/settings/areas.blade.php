...
@section('content')
                    ...
                    <div id="kt_app_content_container" class="" style="padding-top: 20px" >
                        <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
                            <div class="card-header">
                                <h3 class="card-title">{{ trans('settings.areas') }}</h3>
                                <div class="card-toolbar">
                                    <div class="text-center">
                                        <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalareas" >
                                    ...
                                    <table id="table1" class="table table-bordered">
                                        <thead>
                                            <tr class="fw-bold fs-6 text-gray-800">
                                                ...
                                                <th style="text-align: center">{{ trans('settings.governorate') }}</th>
    ...
    <div class="modal fade" tabindex="-1" id="modalareas">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title"><?=trans('settings.add_area')?></h3>
                ...
                <form method="post" action="{{route('admin.add_area')}}" enctype="multipart/form-data" id="form">
                    @csrf
                    <input type="hidden" name="row_id" id="row_id" value="">
                    <div class="row col-md-12" style="margin: 10px">
                        <div class="col-md-6" >
                            <label for="parent_id" class="form-label">{{trans('settings.governorate')}}</label>
                            <select  class="form-select rounded-start-0" name="parent_id" id="parent_id" value="" >
                        ...
                        <div class="col-md-5" >
                            <label for="title" class="form-label">{{trans('settings.title')}}</label>
...
@section('js')
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                table = $("#table1").DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.get_ajax_areas') }}",
                    },
                    columns: [
                        { data: 'id', className: 'text-center' },
                        { data: 'title', className: 'text-center' },
                        { data: 'governorate', className: 'text-center' },
    ...
    <script>
        ...
        {
            $.ajax({
                url: "{{ route('admin.edit_area', ['id' => '__id__']) }}".replace('__id__', id),
                type: "get",
                dataType: "json",
...
{{--    {!! JsValidator::formRequest('App\Http\Requests\Admin\Setting\AddAreaRequest', '#form') !!}--}}
@endsection
