                    ...
                    <form method="post" action="{{ route('admin.save_siteData') }}" enctype="multipart/form-data"
                        ...
                        {{-- <div class="row col-md-12" style="margin: 10px">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="discount_ratio" id="discount_ratio"
                                    value="">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label for="commercial_registration_number"
                                    class="form-label">{{ trans('settings.commercial_registration_number') }}</label>
                                <input type="text" class="form-control" name="commercial_registration_number"
                                    id="commercial_registration_number" value="">
                            </div>
                            <div class="col-md-6">
        ...
        var KTDatatablesServerSide = function() {
            ...
            var initDatatable = function() {
                table = $("#table1").DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.get_ajax_siteData') }}",
                    },
                    columns: [{
                            data: 'id',
