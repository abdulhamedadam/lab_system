...
@section('content')
                    ...
                    <div id="kt_app_content_container" class="" style="padding-top: 20px" >
                        <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
                            <div class="card-header">
                                <h3 class="card-title">{{ trans('settings.governorates') }}</h3>
                                <div class="card-toolbar">
                                    <div class="text-center">
                                        <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalgovernorates" >
    ...
    <div class="modal fade" tabindex="-1" id="modalgovernorates">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title"><?=trans('settings.add_governorate')?></h3>
                ...
                <form method="post" action="{{route('admin.add_governorate')}}" enctype="multipart/form-data" id="form">
                    @csrf
...
@section('js')
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                table = $("#table1").DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.get_ajax_governorates') }}",
                    },
                    columns: [
    ...
    <script>
        function edit_governorate(id)
        {
            $.ajax({
                url: "{{ route('admin.edit_governorate', ['id' => '__id__']) }}".replace('__id__', id),
                type: "get",
                dataType: "json",
...
{{--    {!! JsValidator::formRequest('App\Http\Requests\Admin\Setting\AddGovernorateRequest', '#form') !!}--}}
@endsection
